...
public class EffectLevelUpWithTitle extends Effect {
    ...
    static {
        Skript.registerEffect(EffectLevelUpWithTitle.class, new String[]{
                "levelupwithtitle %player% %string% %string% %number% %number%",
    ...
    protected void execute(Event event) {
        ...
        warn.levelupWithTitle(player, title, subtitle, stay, cooldown);
    }
}
