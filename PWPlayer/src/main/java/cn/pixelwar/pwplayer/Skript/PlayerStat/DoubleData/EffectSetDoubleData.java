...
public class EffectSetDoubleData extends Effect {
    ...
    static {
        Skript.registerEffect(EffectSetDoubleData.class, new String[]{
                "setdoubledata %player% %string% %number%",
        });
    }
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "set doubledata to player: " + playerin.toString(event, debug);
    }
    ...
    protected void execute(Event event) {
        ...
        DoubleDataManager.DoubleDataMap.get(player.getName()).setNum(DoubleDataType.valueOf(type), num);
    }
}
