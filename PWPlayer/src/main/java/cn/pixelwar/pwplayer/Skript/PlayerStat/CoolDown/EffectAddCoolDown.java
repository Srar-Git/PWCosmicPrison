...
public class EffectAddCoolDown extends Effect {
    ...
    static {
        Skript.registerEffect(EffectAddCoolDown.class, new String[]{
                "addcooldown %player% %string% %number%",
        });
    }
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "add cooldown to player: " + playerin.toString(event, debug);
    }
    ...
    protected void execute(Event event) {
        ...
        CoolDownManager.addPlayerCoolDown(player, CoolDownType.valueOf(type), num);
