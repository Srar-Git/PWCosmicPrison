...
public class EffectSetIntData extends Effect {
    ...
    static {
        Skript.registerEffect(EffectSetIntData.class, new String[]{
                "setintdata %player% %string% %number%",
        });
    }
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "set intdata to player: " + playerin.toString(event, debug);
    }
    ...
    protected void execute(Event event) {
        ...
        IntDataManager.IntDataMap.get(player.getName()).setNum(IntDataType.valueOf(type), num);
    }
}
