...
public class EffectAddIntData extends Effect {
    ...
    static {
        Skript.registerEffect(EffectAddIntData.class, new String[]{
                "addintdata %player% %string% %number%",
        });
    }
    ...
    protected void execute(Event event) {
        ...
        IntDataManager.IntDataMap.get(player.getName()).addNum(IntDataType.valueOf(type), num);
    }
}
