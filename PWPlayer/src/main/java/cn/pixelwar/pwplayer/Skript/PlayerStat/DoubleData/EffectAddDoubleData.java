...
public class EffectAddDoubleData extends Effect {
    ...
    static {
        Skript.registerEffect(EffectAddDoubleData.class, new String[]{
                "adddoubledata %player% %string% %number%",
        });
    }
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "add doubledata to player: " + playerin.toString(event, debug);
    }
    ...
    protected void execute(Event event) {
        ...
        DoubleDataManager.DoubleDataMap.get(player.getName()).addNum(DoubleDataType.valueOf(type), num);
    }
}
