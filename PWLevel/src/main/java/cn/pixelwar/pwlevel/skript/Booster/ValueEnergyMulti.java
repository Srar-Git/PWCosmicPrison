...
public class ValueEnergyMulti extends SimpleExpression<Double> {

    static {
        Skript.registerExpression(ValueEnergyMulti.class, Double.class, ExpressionType.COMBINED, "[the] energyboostermulti of %player%");
    }
