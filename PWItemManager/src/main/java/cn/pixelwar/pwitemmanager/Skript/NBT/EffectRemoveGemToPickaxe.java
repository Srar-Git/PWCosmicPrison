...
public class EffectRemoveGemToPickaxe extends Effect {
    private Expression<Player> playerin;
    private Expression<String> gemin;
    private Expression<Number> slotin;

    static {
        Skript.registerEffect(EffectRemoveGemToPickaxe.class, new String[]{
                "removegemfrompickaxe %player% %string% %number%"
        });
    }
    ...
    protected void execute(Event e) {
        ...
        updateSlotLore.removeSlotPickaxeGem(player, gem, slot);
    }
