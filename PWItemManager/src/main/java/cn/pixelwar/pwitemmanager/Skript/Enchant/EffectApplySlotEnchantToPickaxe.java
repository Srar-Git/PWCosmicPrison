...
public class EffectApplySlotEnchantToPickaxe extends Effect {
    ...
    static {
        Skript.registerEffect(EffectApplySlotEnchantToPickaxe.class, new String[]{
                "applyenchantpickaxeinslot %player% %number% %string% %number% %number%"
        });
    }
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "add enchants to player slot's tool: " + playerin.toString(event, debug);
    }
