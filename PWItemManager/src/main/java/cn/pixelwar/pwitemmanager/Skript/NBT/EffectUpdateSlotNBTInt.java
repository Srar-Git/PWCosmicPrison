...
public class EffectUpdateSlotNBTInt extends Effect {
    ...
    static {
        Skript.registerEffect(EffectUpdateSlotNBTInt.class, new String[]{
//                "updateslotitemnbt %player% %number% %string% %string%",
