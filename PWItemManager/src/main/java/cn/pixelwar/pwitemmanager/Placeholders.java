    ...
    public class Placeholders extends PlaceholderExpansion {
        ...
        public String onPlaceholderRequest(Player p, String identifier) {
            ...
            if (identifier.equals("xppercent")) {
                ...
                if (percent<=20){return ChatColor.RED+""+ percent;}
                if (percent<=40){return ChatColor.GOLD+""+ percent;}
                if (percent<=70){return ChatColor.YELLOW+""+ percent;}
                else{return ChatColor.GREEN+""+ percent;}
