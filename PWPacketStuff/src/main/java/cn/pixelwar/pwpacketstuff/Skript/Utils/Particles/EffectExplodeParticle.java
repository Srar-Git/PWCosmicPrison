...
public class EffectExplodeParticle extends Effect {
    private Expression<Player> playerin;
    private Expression<Location> locin;

    static {
        Skript.registerEffect(EffectExplodeParticle.class, new String[]{
                "explodeparticle %player% %location%",
        });
    }
    ...
    protected void execute(Event event) {
        ...
        cn.pixelwar.pwpacketstuff.Utils.Particles.Enchants.ExplodeEffect(player, loc);
    }
}
