...
public class EffectNExpoldeParticle extends Effect {
    private Expression<Player> playerin;
    private Expression<Location> locin;

    static {
        Skript.registerEffect(EffectNExpoldeParticle.class, new String[]{
                "nexplodeparticle %player% %location%",
        });
    }
    ...
    protected void execute(Event event) {
        ...
        cn.pixelwar.pwpacketstuff.Utils.Particles.Enchants.NExplodeEffect(player, loc);
    }
}
